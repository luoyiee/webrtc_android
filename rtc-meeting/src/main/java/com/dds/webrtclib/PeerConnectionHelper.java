...
//https://github.com/qunarcorp/imsdk-android/blob/76f73b10df172ee4d633c430973a6c2fa48a38bf/lib_rtc/src/main/java/com/qunar/im/rtc/webrtc/WebRtcClient.java#L60
public class PeerConnectionHelper {
    ...
    public static final int audioStartBitrate = 32; // kbps
    ...
    private class Peer implements SdpObserver, PeerConnection.Observer {
        ...
        ///https://github.com/ddssingsong/webrtc_android/issues/57
        @Override
        public void onCreateSuccess(SessionDescription origSdp) {
            ...
            if (videoEnable) {
                sdpDescription = setStartBitrate(VIDEO_CODEC_H264, true, sdpDescription, videoStartBitrateKbps);
            }
